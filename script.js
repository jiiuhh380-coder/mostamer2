...
function settings() {
    ...
    <div class="tw">
        ...
        <div style="padding:20px">
            ...
            <!-- حفظ نسخة احتياطية -->
            <div class="settings-section">
                <h4>💾 حفظ نسخة احتياطية</h4>
                <div class="fg">
                    <div class="ff full">
                        <label>📁 حفظ في مجلد محدد</label>
                        <input type="file" id="save_backup_folder" webkitdirectory directory multiple>
                    </div>
                    <div class="ff full">
                        <label>📝 اسم النسخة الاحتياطية</label>
                        <input type="text" id="backup_name" placeholder="نسخة احتياطية_YYYYMMDD_HHMMSS">
                    </div>
                </div>
                <div style="margin-top:15px">
                    <button class="btn btn-success" onclick="saveBackupToFolder()">💾 حفظ النسخة الاحتياطية</button>
                </div>
            </div>
